...
const devConfig = {
    ...
    devServer: { // Configuration for the development server.
        port: 8081, // Setting the port for the development server to 8081.
    ...
    plugins: [ 
        new ModuleFederationPlugin({
            name: 'marketing', // Name of the micro-frontend application.
            filename: 'remoteEntry.js', // Name of the file that will be generated for the remote entry point.
            exposes:{
                './MarketingApp': './src/bootstrap' // Exposing the MarketingApp module for other applications to consume.
            },
